            ...
            <div class="row">
                    ...
                    <div class="product__details__pic">
                        <div class="product__details__pic__item">
                            <img class="product__details__pic__item--large"
                                src="{{asset($products->image_two)}}" alt="Jony">
                        </div>
                        <div class="product__details__pic__slider owl-carousel">
                            <img data-imgbigurl="{{asset($products->image_one)}}"
                                src="{{asset($products->image_one)}}" alt="">
                            <img data-imgbigurl="{{asset($products->image_two)}}"
                                src="{{asset($products->image_two)}}" alt="">
                            <img data-imgbigurl="{{asset($products->image_three)}}"
                                src="{{asset($products->image_three)}}" alt="">
                            <img data-imgbigurl="{{asset($products->image_two)}}"
                                src="{{asset($products->image_two)}}" alt="">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product__details__text">
                        ...
                        <p>{{ strip_tags($products->short_description)}}</p>
                        
                        <form action="{{url('add/to-cart/'.$products->id)}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                        ...
                        <a href="{{url('add/to-wishlist/'.$products->id)}} " class=" bg-success btn text-white"><i class="fa fa-heart"></i> Add to Wishlist</a>
                        ...
                        <ul>
                            <li><b>Availability</b> <span>
                                ...
                                @else
                                    ...
                                    <span style="color:green">In Stock   ({{$products->product_quantity }})</span>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tabs-1" role="tabpanel">
                                <div class="product__details__tab__desc">
                                    ...
                                    <p>{{ strip_tags($products->long_description)}}</p>
                                </div>
                            </div>
                    ...
                    <div class="product__item">
                        <div class="product__item__pic set-bg" data-setbg="{{asset($related->image_one)}}">
                            <ul class="product__item__pic__hover">
                                ...
                                <!--Product add to Cart-->
                                <form action="{{url('add/to-cart/'.$related->id)}}" method="POST" enctype="multipart/form-data">
                                    @csrf
